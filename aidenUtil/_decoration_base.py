...
class Override():
	...
	def __init__(self, func):
		...
		else_make_key(Override.functions, class_name, {})
		else_make_key(Override.functions[class_name], name, [])

		temp = {}
		temp[str(type_list_from_arg_dict(args))] = func
		Override.functions[class_name][name].append(temp)
	...
	def call_func(passed_function, *args, **kwargs):
		...
		function_list = key_exists(Override.functions[class_name], name)
